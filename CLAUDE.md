...
- ⬜ Phase 6–8 — Apply dispatcher → Slack → polish (PLAN.md §9). Nợ kỹ thuật: CV Studio (HTML live preview, theme gallery, raw LaTeX Monaco, diff giữa 2 version); tailor chạy đồng bộ (Phase 8 đẩy vào job queue); cover letter (SKILL.md §2 bước 4) làm ở Phase 6 khi apply cần.
